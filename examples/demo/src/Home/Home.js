...
const Home = ({
  ...
  <>
    ...
    <div className="af-home container">
      ...
      <h1 className="af-title--content">{`Vos devis en cours (${numberItemsTotal})`}</h1>
              ...
              <Table.Th classModifier="sortable">
                <span className="af-table__th-content">
                  <Button
                    ...
                    onClick={() => {
                      onChangeFilter('fullName');
                    }}>
                    <span className="af-btn__text">Nom prénom</span>
                    <i
                      className={
                        'glyphicon ' +
                        (filters.columns.fullName.value === null
                          ? 'glyphicon-sorting'
                          : `glyphicon-sorting-${
                              filters.columns.fullName.value
                            }`)
                      }
                    />
                  </Button>
              ...
              <Table.Th classModifier="sortable">
                <span className="af-table__th-content">
                  <Button
                    ...
                    classModifier="table-sorting"
                    onClick={() => {
                      onChangeFilter('agent');
                    }}>
                    <span className="af-btn__text">Agent</span>
                    <i
                      className={
                        'glyphicon ' +
                        (filters.columns.agent.value === null
                          ? 'glyphicon-sorting'
                          : `glyphicon-sorting-${filters.columns.agent.value}`)
                      }
                    />
                  </Button>
                </span>
              ...
              <Table.Th classModifier="sortable">
                <span className="af-table__th-content">
                  <Button
                    ...
                    classModifier="table-sorting"
                    onClick={() => {
                      onChangeFilter('beginDate');
                    }}>
                    <span className="af-btn__text">Date d'entrée</span>
                    <i
                      className={
                        'glyphicon ' +
                        (filters.columns.beginDate.value === null
                          ? 'glyphicon-sorting'
                          : `glyphicon-sorting-${
                              filters.columns.beginDate.value
                            }`)
                      }
                    />
                  </Button>
